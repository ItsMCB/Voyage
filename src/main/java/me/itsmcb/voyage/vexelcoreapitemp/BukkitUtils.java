package me.itsmcb.voyage.vexelcoreapitemp;
...
public class BukkitUtils {
    ...
    public static Component interactiveMessageCopyContent(String messageText, String messageHoverText, String contentToCopy) {
